                ...
                <label htmlFor="signUpForSms" className="flex items-start gap-2 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-700">
                    ...
                    <span className="block text-xs text-gray-500 mt-0.5">
                      By checking this box, you consent to receive text messages about new M&amp;A deals that match your criteria from CIM Amplify. Reply STOP to opt out. Reply HELP for assistance. Standard message and data rates may apply. Message frequency may vary. Your mobile information will not be sold or shared with third parties for promotional or marketing purposes. Terms and privacy policy can be found at{" "}
                      <a
